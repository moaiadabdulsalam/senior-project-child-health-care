...
-- AlterTable
ALTER TABLE "Medication" DROP COLUMN "Duration",
DROP COLUMN "rememberTime",
ADD COLUMN     "duration" TIMESTAMP(3) NOT NULL,
ADD COLUMN     "rememberNotify" BOOLEAN NOT NULL DEFAULT false,
DROP COLUMN "amountPerDay",
ADD COLUMN     "amountPerDay" INTEGER NOT NULL;
